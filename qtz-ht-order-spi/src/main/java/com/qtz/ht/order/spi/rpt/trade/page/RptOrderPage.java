...
/**
 * Title:RptOrderPage<br/>
 * Description:(报表专用订单表Page分页类)<br/>
 * Copyright: Copyright (c) 2016<br/>
 * Company: 深圳市擎天柱信息科技有限公司<br/>
 * @author  甘佳 jackgrays@matrix.com
 * @version v1.0 2016-03-11
 */
public class RptOrderPage extends Pager<RptOrder,Long> implements Serializable {

	/**(序列化UID)*/
	private static final long serialVersionUID = -6253699756467076781L;
    /**(订单id)*/
	private Long dmId;
    /**(商家id)*/
