...
/**
 * Title:RptWithdrawalsApply<br/>
 * Description:(报表专用提现记录表VO实体类)<br/>
 * Copyright: Copyright (c) 2016<br/>
 * Company: 深圳市擎天柱信息科技有限公司<br/>
 * @author  甘佳 jackgrays@matrix.com
 * @version v1.0 2016-03-22
 */
public class RptWithdrawalsApply extends VO<Long> implements Serializable {

	/**(序列化UID)*/
	private static final long serialVersionUID = -5056534603974161888L;
    /**()*/
	private Long dmID;
    /**()*/
	private Long userId;
