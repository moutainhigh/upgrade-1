...
/**
 * Title:RptGloadLog<br/>
 * Description:(报表专用金币记录表VO实体类)<br/>
 * Copyright: Copyright (c) 2016<br/>
 * Company: 深圳市擎天柱信息科技有限公司<br/>
 * @author  甘佳 jackgrays@matrix.com
 * @version v1.0 2016-03-14
 */
public class RptGloadLog extends VO<Long> implements Serializable {

	/**(序列化UID)*/
	private static final long serialVersionUID = 4065960962474068493L;
    /**()*/
	private Long dmId;
    /**(用户ID)*/
	private Long userId;
