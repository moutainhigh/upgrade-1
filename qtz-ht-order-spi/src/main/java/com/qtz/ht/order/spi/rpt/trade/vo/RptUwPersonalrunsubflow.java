...
/**
 * Title:RptUwPersonalrunsubflow<br/>
 * Description:(报表专用个人分润表VO实体类)<br/>
 * Copyright: Copyright © 2016<br/>
 * Company: 深圳市擎天柱信息技术有限公司<br/>
 * @author 甘佳-jackgrays@matrix.com
 * @version v1.0 2016-04-28
 */
public class RptUwPersonalrunsubflow extends VO<Long> implements Serializable {

    /**(序列化UID)*/
    private static final long serialVersionUID = -7035419811826679355L;
    /**(主键ID)*/
    private Long dmId;
    /**(用户ID)*/
    private Long userId;
    ...
    public String toString() {
        return "RptUwPersonalrunsubflow[" +
        "dmId=" + dmId +
        ",userId=" + userId +
