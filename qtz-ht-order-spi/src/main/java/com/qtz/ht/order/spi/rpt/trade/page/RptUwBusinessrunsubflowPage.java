...
import com.qtz.ht.order.spi.rpt.trade.vo.RptUwBusinessrunsubflow;

/**
 * Title:RptUwBusinessrunsubflowPage<br/>
 * Description:(报表专用商家分润表Page分页类)<br/>
 * Copyright: Copyright © 2016<br/>
 * Company: 深圳市擎天柱信息技术有限公司<br/>
 * @author 甘佳-jackgrays@matrix.com
 * @version v1.0 2016-04-28
 */
public class RptUwBusinessrunsubflowPage extends Pager<RptUwBusinessrunsubflow,Long> implements Serializable {

    /**(序列化UID)*/
    private static final long serialVersionUID = -3199814270462180833L;
    /**(主键ID)*/
    private Long dmId;
    /**(用户ID)*/
    private Long userId;
    ...
    public String toString() {
        return "RptUwBusinessrunsubflowPage[" +
        "dmId=" + dmId +
        ",userId=" + userId +
