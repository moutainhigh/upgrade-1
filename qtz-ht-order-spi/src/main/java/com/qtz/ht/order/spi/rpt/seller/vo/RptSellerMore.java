package com.qtz.ht.order.spi.rpt.seller.vo;
...
/**
 * Title:RptSellerMore<br/>
 * Description:(商家统计表(多)VO实体类)<br/>
 * Copyright: Copyright (c) 2016<br/>
 * Company: 深圳市擎天柱信息科技有限公司<br/>
 * @author  甘佳 jackgrays@matrix.com
 * @version v1.0 2016-03-11
 */
public class RptSellerMore extends VO<Long> implements Serializable {

	/**(序列化UID)*/
	private static final long serialVersionUID = -4941703132091167715L;
    /**()*/
	private Long dmId;
    /**(统计类型0天,1周,2月,3年)*/
