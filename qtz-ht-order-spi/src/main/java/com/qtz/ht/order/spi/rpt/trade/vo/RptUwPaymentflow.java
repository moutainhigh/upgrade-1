...
/**
 * Title:RptUwPaymentflow<br/>
 * Description:(报表专用商家货款表VO实体类)<br/>
 * Copyright: Copyright © 2016<br/>
 * Company: 深圳市擎天柱信息技术有限公司<br/>
 * @author 甘佳-jackgrays@matrix.com
 * @version v1.0 2016-04-28
 */
public class RptUwPaymentflow extends VO<Long> implements Serializable {

    /**(序列化UID)*/
    private static final long serialVersionUID = 5366819133300883810L;
    /**(主键ID)*/
    private Long dmId;
    /**(订单ID)*/
