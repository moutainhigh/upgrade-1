...
/**
 * 任务类型 调度 底层的多线程实现会调用该接口 ClassName: QuartzTaskJob <br/>
 * Function: TODO (). <br/>
 * Reason: TODO (). <br/>
...
public class QuartzTaskJob extends QuartzJobBean
{
    ...
    /** 初始化日志对象 */
    private static Logger log = Logger.getLogger(QuartzTaskJob.class);
    ...
    protected void executeInternal(JobExecutionContext context)
    {
        ...
        TaskHandle th = SpringContextHelper.getBean(beanId);
        QuartzScan quartzScan = SpringContextHelper.getBean("quartzScanImpl");
        TaskResult r = null;
        try
        {
