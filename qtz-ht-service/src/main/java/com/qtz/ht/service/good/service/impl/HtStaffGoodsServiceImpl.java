...
import com.qtz.ht.service.good.dao.HtStaffGoodsDao;
...
import com.qtz.ht.spi.good.page.HtStaffGoodsPage;
...
/**
 * <p>
 * Title:HtStaffGoodsServiceImpl
 * </p>
 * <p>
 * Description:商户商品服务实现类
 * </p>
 * <p>
...
public class HtStaffGoodsServiceImpl extends BaseServiceImpl<HtStaffGoods, Long> implements HtStaffGoodsService
{
    ...
    @Override
	public HtStaffGoods addVo(HtStaffGoods vo) throws ServiceException {
	...
	@Override
	public void addList(List<HtStaffGoods> list) throws ServiceException {
		for (HtStaffGoods vo : list) {
			if (null == vo.getDmId()) vo.setDmId(idService.generateId());
		}
		super.addList(list);
	}
    ...
    public HtStaffGoods add(HtStaffGoods vo, List<HtGoodCateAsso> cateS, String goodDesc, List<HtGoodsAlbum> albums,
		...
		if(null == vo.getDmId() || vo.getDmId() < 1){
...
//			as.setBusiId(vo.getBusiId());
    ...
    @Override
    public Pager<HtStaffGoods, Long> query(Pager<HtStaffGoods, Long> page, Class<HtStaffGoods> clazz)
    ...
    @Override
    public void modBatchSupplier(HtStaff staff, List<HtBusiness> list, String operateContent, String voucherAddr)
        throws ServiceException
    {
        HtBusiness vo = null;
        ...
        for (HtBusiness htBusiness : list)
        {
            ...
            if(log.getDmId() == null || log.getDmId() < 1){
                log.setDmId(this.idService.generateId());
            }
            logList.add(log);
        }
    ...
    /**
     * 根绝商家编号 修改商家的商品上下架状态 updateStuffShopStatus:(). <br/>
     * TODO().<br/>
     * 
     * @author yxd
     * @param staff 操作人
	...
	public List<HtStaffGoods> findHotSearchGoods() throws ServiceException {
		...
		String hotGoodsIdStr=CfgHelper.getValue("HOT_SEARCH");
