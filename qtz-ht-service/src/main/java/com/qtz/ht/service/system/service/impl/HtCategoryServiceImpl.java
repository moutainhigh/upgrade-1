...
import com.qtz.commons.text.RegexUtil;
import com.qtz.ht.service.good.dao.HtGoodCateAssoDao;
import com.qtz.ht.service.system.dao.CategoryDao;
...
@Service(value="htCategoryServiceImpl")
public class HtCategoryServiceImpl extends BaseServiceImpl<HtCategory, Long> implements HtCategoryService {
	...
	@Override
	public HtCategory addVo(HtCategory vo) throws ServiceException {
			if (null == vo.getDmId()) vo.setDmId(idService.generateId());
		return super.addVo(vo);
	}

	@Override
	public void addList(List<HtCategory> list) throws ServiceException {
		for (HtCategory vo : list) {
				if (null == vo.getDmId()) vo.setDmId(idService.generateId());
		}
		super.addList(list);
	}
...
//		}
		...
		if(entity.getDmId()==null||entity.getDmId()<1){
			entity.setDmId(idService.generateId());
		}
		entity.setName(name);
