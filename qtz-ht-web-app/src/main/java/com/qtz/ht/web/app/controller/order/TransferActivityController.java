...
import com.qtz.base.dto.authentication.UserAuthen;
...
import com.qtz.member.spi.authentication.service.AuthenService;
...
public class TransferActivityController extends BaseController {
	...
	*/
	...
	public void subOrder(@RequestParam("token") String sid, @RequestParam("goodId") Long goodId,
		...
		log.info("TransferActivityController subOrder|params:sid="+sid+",goodId="+goodId);
		try {
			...
			log.error("TransferActivityController subOrder exception|sid="+sid+",goodId="+goodId,e);
