...
public class StepsInterceptor implements HandlerInterceptor{
	SessionService sessionService = (SessionService) SpringContextHelper.getBean("sessionService");
	
	HtUserService usersService = (HtUserService) SpringContextHelper.getBean("htUserService");
	//排除
