package com.qtz.ht.web.admin.controller.user;
...
import com.qtz.ht.session.spi.user.page.HtStaffPage;
...
import com.qtz.ht.web.admin.model.StaffModel;
	...
	*/
	...
	public void updatePasswordByPhoneCode(@RequestParam(value="token") String sid,
		...
		try {
			...
			log.error(e);
			RespJsonPHandler.respError(e.getCode(), e.getMsg(), response, request);
		}
